                    ...
                    <div class="card card-general shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <select name="" id="select-form" class="custom-select my-3">
                                <option data-target="#form-cadastro-paciente">01 - Formulário de Agendamento de Consulta
...
<div class="card mb-3 shadow-sm card-general">
    ...
    <div class="card-body">
        ...
        <form action="V_agendamentoConsulta.php" method="post" class="form-general">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 spacing">
                    ...
                    <input type="text" name="paciente" class="form-control" maxlength="50" placeholder="Ex: Cesar" required="">
                </div>

                <div class="col-md-6 spacing">
                    <label>CPF Paciente</label>
                        <input type="text" name="cpfPaciente"  class="form-control" class="form-control" maxlength="50" placeholder="Ex: Cesar" required="">
                    </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 spacing">
                    <label>Médico</label>
                    <input type="text" name="medico" class="form-control" maxlength="50" placeholder="Ex: Cesar" required="">
                </div>

                <div class="col-md-6 spacing">
                    <label>CPF - Medico</label>
                        <input type="text" name="cpdMed"  class="form-control" class="form-control" maxlength="50" placeholder="Ex: Cesar" required="">
                    </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-md-6 spacing">
                    <label>Horário</label>
                    <input type="time" name="horario" class="form-control" maxlength="50" placeholder="Ex: Cesar" required="">
                </div>

                <div class="col-md-6 spacing">
                <label>Data</label>
                        <input type="date" name="data"  class="form-control" class="form-control" maxlength="50" placeholder="Ex: Cesar" required="">
                </div>
