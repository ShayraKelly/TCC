                            ...
                            <tr>
                                <td>
                                    <p><strong>Senha:</strong>
                                       <a href="#"><span class="badge badge-danger" style="color:#fff ;">Alterar</span></a>
                                                             </p>
                                </td>
                ...
                <div class="tab-pane fade show active" id="pills-timeline" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    ...
                                    <div class="timeline-panel" id="441645">
                                        <div class="timeline-heading">
                                                                                                    <div class="timeline-status bg-secondary"><i class="fas fa-pause-circle"></i> Aguardando
                                                </div>
                                            
                                                                                                    <h4 class="timeline-title">Cadastro de paciente</h4>
                                                                                                <p class="text-muted"><i class="fas fa-info-circle"></i> 11 Ago 2022 19:14 por <a href="">hiagocarlos</a>
                                            </p>
                                            <p class="mb-1 btn-acesso-req">
                                                <button class="btn btn-link" style="text-decoration: none;" id="441645" data-divisao="7">Acessar
                                                    requerimento
                                                </button>
                                            </p>
                                        </div>
                ...
                <p class="mb-2"><strong>Data da decisão: </strong></p>
                                ...
                                <li>
                                            ...
                                            <div class="timeline-panel" id="433835">
                                                <div class="timeline-heading">
                                                <div class="timeline-status bg-danger"><i class="fas fa-ban"></i> Reprovado
                                                </div>
                                                    ...
                                                    <p class="mb-1 btn-acesso-req">
                                                        <button class="btn btn-link" style="text-decoration: none;" id="433835" data-divisao="12">Acessar
                                                            requerimento
                                                        </button>
                                                    </p>
                                                </div>
