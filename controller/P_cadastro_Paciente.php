            ...
            <form action="" method="post" class="form-general">
                ...
                <div class="form-group row">
                    <div class="col-md-6 spacing">
                        ...
                        <input type="text" name="usuario_sofreu_acao" class="form-control" maxlength="7" placeholder="Ex: 1234567" required="">
                    </div>

                    <div class="col-md-6 spacing">
                        <label>CPF</label>
                        <input type="text" name="usuario_sofreu_acao" class="form-control" maxlength="14" placeholder="Ex: 000.000.000-00" required="">
</div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6 spacing">
                        ...
                        <input type="text" name="usuario_sofreu_acao" class="form-control" maxlength="50" placeholder="Ex: 12/12/2022" required="">
                    </div>
            ...
            <hr class="hr">
                ...
                <p class="mb-2"><strong>Data da decisão: </strong></p>
                             ...
                             <br>
                              ...
                              <a href="#">        <span  onclick="javascript:abrir('P_aprovar_Cadastro_Paciente.php');" class="badge badge-success">Atualizar</span>  </a>   
            ...
            <div class="col-md-9">
					...
					<div style="min-height: 250px;">
						<div class="text-center texto-vertical">
							...
							<p><strong>Data da atualização:</strong> 11 Ago 2022 - 18:47:48</p>
						</div>
					</div>
                      <!-- [SE O REQUERIMENTO FOR DO TIPO ADM, TODO O CÓDIGO ABAIXO SERÁ DESCONSIDERADO] -->
